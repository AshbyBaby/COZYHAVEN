        ...
        <li class="nav-item">
          ...
          <div class="collapse" id="ui-basic1">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"> <a class="nav-link" href="userreg_piereport.php">UserReport</a></li>
              <li class="nav-item"> <a class="nav-link" href="report_totalbookings.php">TotalBooking Report</a></li>
              <li class="nav-item"> <a class="nav-link" href="homereg.php">Home Report</a></li>
              <li class="nav-item"> <a class="nav-link" href="report_payment.php">PaymentView Report</a></li>
          ...
          <ul class="navbar-nav navbar-nav-right">
            <li class="nav-item nav-profile dropdown">
              <a class="nav-link dropdown-toggle" href="#" >
                <img src="..\upload\logo.jpeg" alt="profile" />
